...
// .wrangler/tmp/bundle-iYFpBm/checked-fetch.js
...
// .wrangler/tmp/bundle-iYFpBm/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
...
// .wrangler/tmp/bundle-iYFpBm/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
...
// .wrangler/tmp/pages-nBMej6/af1zeiuvys7.js
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
...
// .wrangler/tmp/pages-nBMej6/bundledWorker-0.35283351441909216.mjs
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
  ...
  function be(e, t) {
    ...
    for (var a = {}, s = t || {}, r = s.decode || Pe, i = 0; i < e.length; ) {
      ...
      if (a[c] === void 0) {
        ...
        h.charCodeAt(0) === 34 && (h = h.slice(1, -1)), a[c] = Ee(h, r);
      }
      i = o + 1;
    }
    return a;
...
__name(U, "U");
__name2(U, "U");
async function E2(e, { request: t, assetsFetcher: a, ctx: s }, { path: r, searchParams: i }) {
...
var M = /* @__PURE__ */ __name2(class {
  ...
  async runRouteMiddleware(t) {
    ...
    let s = await E2(a, this.reqCtx, { path: this.path, searchParams: this.searchParams, headers: this.headers, status: this.status });
  ...
  applyRouteDest(t, a, s) {
    ...
    return w(this.searchParams, R.searchParams), P(this.path) || (this.path = R.pathname), r;
  }
  ...
  async checkPhase(t) {
    ...
    let r = "miss";
    return s || t === "miss" || t === "error" ? r = "hit" : a && (r = U(t)), this.checkPhase(r);
  }
  async run(t = "none") {
...
async function ke(e, { path: t = "/404", status: a, headers: s, searchParams: r, body: i }, n) {
  ...
  if (i !== void 0)
    ...
    c = await E2(n[t], e, { path: t, status: a, headers: s, searchParams: r });
  let h = s.normal;
