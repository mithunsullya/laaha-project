...
var ys = { async fetch(e, t, a) {
  ...
  return i.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: R }, async () => r.run({ env: t, ctx: a, cf: e.cf }, async () => {
    ...
    let c = D(e);
    return Y({ request: c, ctx: a, assetsFetcher: t.ASSETS }, f, y, m);
  }));
} };
export {
  ys as default
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.8797183207129249.mjs.map
