...
var ce = /* @__PURE__ */ __name((e, t, a, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let i of ne(t))
      !re.call(e, i) && i !== a && N(e, i, { get: () => t[i], enumerable: !(s = ae(t, i)) || s.enumerable });
  return e;
}, "ce");
var V = /* @__PURE__ */ __name((e, t, a) => (a = e != null ? se(ie(e)) : {}, ce(t || !e || !e.__esModule ? N(a, "default", { value: e, enumerable: true }) : a, e)), "V");
var m;
var u = M(() => {
  m = { collectedLocales: [] };
});
...
function de(e, t) {
  ...
  if (!d && !t?.domains?.includes(c.hostname) && !t?.remotePatterns?.find((w) => pe(c, w)))
    return;
  let h = e.headers.get("Accept") ?? "", g = t?.formats?.find((w) => h.includes(w))?.replace("image/", "");
  return { isRelative: d, imageUrl: c, options: { width: r, quality: n, format: g } };
}
__name(de, "de");
function he(e, t, a) {
  let s = new Headers();
...
async function z(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let r = globalThis[me], n = /* @__PURE__ */ __name(async () => {
          let c = await e.json();
...
var E = /* @__PURE__ */ __name(class {
  ...
  applyLocaleRedirects(t) {
    if (!t.locale?.redirect || !/^\^(.)*$/.test(t.src) && t.src !== this.path || this.headers.normal.has("location"))
      return;
    let { locale: { redirect: s, cookie: i } } = t, r = i && this.cookies[i], n = A(r ?? ""), c = A(this.reqCtx.request.headers.get("accept-language") ?? ""), h = [...n, ...c].map((g) => s[g]).filter(Boolean)[0];
    if (h) {
...
var ys = { async fetch(e, t, a) {
  ...
  return i.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: R }, async () => r.run({ env: t, ctx: a, cf: e.cf }, async () => {
    ...
    let c = D(e);
    return Q({ request: c, ctx: a, assetsFetcher: t.ASSETS }, f, y, m);
  }));
} };
export {
  ys as default
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.8620764566273431.mjs.map
