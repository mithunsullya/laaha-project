...
__name(U, "U");
async function E(e, { request: t, assetsFetcher: a, ctx: s }, { path: r, searchParams: i }) {
...
async function ke(e, { path: t = "/404", status: a, headers: s, searchParams: r, body: i }, n) {
  ...
  if (i !== void 0)
    ...
    c = await E(n[t], e, { path: t, status: a, headers: s, searchParams: r });
  let h = s.normal;
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.35283351441909216.mjs.map
